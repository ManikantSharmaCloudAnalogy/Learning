...
Calculation Rule: 
1. To calculate the score: check each element in the rotated array.
2. If the element’s value is less than or equal to its index, you get 1 point."
*/
...
console.log(rotation([2,3,1,4,0]));
